...
| **Timestamp proofs** | OpenTimestamps `.ots` files in `timestamps/` — cryptographic attestations over released archive files, not authored content | [CC-BY-4.0](LICENSES/CC-BY-4.0.txt) |
